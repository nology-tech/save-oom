...
const LevelSelectCard = ({headingText, headingImg, paragraphText, buttonText, buttonStyle, isLocked}) => {
  return (
    <div className='card'>
      <NavBarHeading headingText={headingText} headingImg={headingImg} headingStyle={"level-select"} isLocked={isLocked}/>
